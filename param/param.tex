...
These results seem to suggest that, even though evolving towards higher intergenic distances would allow populations to reach greater fitnesses, there is a stronger selection pressure that keeps intergenic distances low.
A possible hypothesis to explain this discrepancy is the presence of a second-order selection pressure for robustness.
If genomes with larger intergenic distances have offspring that on average ends up with lower fitnesses after mutations, then selecting smaller average intergenic distances could make evolutionary sense.
This hypothesis would for example be testable by measuring the average fitness of the offspring of individuals evolved with different average intergenic distances.
