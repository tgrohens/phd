...
\begin{figure}[H]
  ...
  \end{subfigure}
  \caption[Influence of environmental supercoiling on the phenotype of the example individual in Figure~\ref{fig:13genes}]{Influence of the environment supercoiling $\sigma_{env}$ on the stable state local supercoiling level (top row) and gene transcription levels (bottom rows) of the example individual.
...
\begin{figure}[H]
  ...
  \end{subfigure}
  \caption[Effect of a genomic inversion on the example individual in Figure~\ref{fig:13genes}]{Genome, local supercoiling and gene expression levels of a new individual obtained from the individual in figure~\ref{fig:13genes} by switching the positions and orientations of genes B and C.}
  \label{fig:inversion}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption[Effect of an inversion on the hand-drawn genome in Figure \ref{fig:network}]{Result of the inversion of a genomic segment containing genes B and C from the individual presented in figure~\ref{fig:network}.
