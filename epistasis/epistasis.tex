...
Supercoiling mutations seem to play a role in finding local optimizations on the fitness landscape that stems from the genomic organization of individuals, rather than open new evolutionary paths through a broad regulatory effect on gene activity.
